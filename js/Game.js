class Game {
  ...
  start() {
    ...
    this.addSprites(obstacle1,obstacle1pos.length,obstacle1Img,0.04,obstacle1pos)
    this.addSprites(obstacle2,obstacle2pos.length,obstacle2Img,0.04,obstacle2pos)
  }
